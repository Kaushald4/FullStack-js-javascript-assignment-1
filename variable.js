/****************************************************************
 * Q1. Create a variable.js file and declare variables and
...
console.log(
    `\t [name: ${name} -- Data Type: ${typeof name}] 
     \t [isActive: ${isActive} -- Data Type: ${typeof isActive}]
     \t [location: ${location} -- Data Type: ${typeof location}]
     \t [health: ${health} -- Data Type: ${typeof health}]
     \t [power: ${power} -- Data Type: ${typeof power}]
`
);

/******************************************************************
 * Q2. Declare variables to store your first name, last name,
 *     marital status, country and age and display them using
...
console.log(`Avengers: ${movieName}`);
...
jsFile = "python";
isTrue = jsFile.includes("script");
console.log(`Is python containes word script: ${isTrue}`);

/*************************************************************************
 * Q5. Split the string into an array using split() method
 */
let characters = "IronMan Hulk CaptionAmerica Thor SpiderMan";
...
let indexOfScript = language.lastIndexOf("script");
console.log(indexOfScript);
...
console.log(`position of word because: ${sentence}`);

/*************************************************************************************
 * Q9. Use trim() to remove any trailing whitespace at the
 * beginning and the end of a string.
 */
let values = "    Boolean value is either true or false     ";
values = values.trim();
console.log(values);
 ...
 */
// Truthy values
const quoteByFrankZappa = "So many books, so little time.";
const trueValue = true;
const isTrueNumber = 87;
...
console.log(`\t Ans 17.`);
console.log(
    `\t YYYY-MM-DD HH:mm -> ${currentYear}-${pad(currentMonth + 1, 2)}-${pad(currentDate, 2)} ${pad(
        currentHour,
        2
    )}:${pad(currentMinute, 2)}`
);
...
console.log(
    `\t DD-MM-YYYY HH:mm -> ${pad(currentDate, 2)}-${pad(currentMonth + 1, 2)}-${currentYear} ${pad(
        currentHour,
        2
    )}:${pad(currentMinute, 2)}`
);
